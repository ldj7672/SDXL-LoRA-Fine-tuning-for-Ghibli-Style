...
# 기본 설정
BASE_DIR="output_ghibli"
OUTPUT_DIR="output_visualization_additional_2"
BASE_RESULTS_DIR="${OUTPUT_DIR}/base_model_results"
# PROMPTS=(
...
for exp_dir in "${EXPERIMENT_DIRS[@]}"; do
    ...
    echo "=========================================="
    echo "Running inference for experiment: ${exp_name}"
    echo "LoRA model path: ${lora_path}"
    ...
    echo "Completed inference for ${exp_name}"
    echo "=========================================="
done
